  ...
  social: [
    {
      name: 'Instagram',
      href: '#',
      icon: ({ className, 'aria-hidden': ariaHidden }: { className?: string, 'aria-hidden'?: boolean }) => (
    ...
    },
    {
      ...
      icon: ({ className, 'aria-hidden': ariaHidden }: { className?: string, 'aria-hidden'?: boolean }) => (
        <svg className={className} fill="currentColor" viewBox="0 0 24 24" aria-hidden={ariaHidden}>
          <path
            fillRule="evenodd"
            d="M12 3C7.03 3 3 6.37 3 10.5c0 2.89 1.92 5.41 4.76 6.67-.16.57-.6 2.06-.69 2.38-.11.4.15.39.31.28.13-.08 2.04-1.39 2.87-1.95.57.08 1.16.12 1.75.12 4.97 0 9-3.37 9-7.5S16.97 3 12 3"
            clipRule="evenodd"
          />
        </svg>
      )
